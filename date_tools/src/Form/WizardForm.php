...
/**
 * @file
 * Contains \Drupal\date_tools\Form\WizardForm.
 */

namespace Drupal\date_tools\Form;

use Drupal\Core\Form\FormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * The Date wizard implementation.
 */
class WizardForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['field']['advanced']['field_type'] = array(
      '#type' => 'select',
      '#options' => $this->getWizardFieldTypes(),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $view_name = $this->build($form_state['values']);
    menu_rebuild();
   ...
   * @todo.
   */
  protected function build($form_values) {
    extract($form_values);
    ...
    if (!array_key_exists($bundle, $types)) {
      $this->createContentType($name, $bundle, $type_description, $type_settings);
   ...
   * @todo.
   */
  protected function createContentType($name, $bundle, $description, $type_settings = array()) {
   ...
   * @return array
   */
  protected function getWizardTypes() {
    $widget_types = array();
   ...
   * @return array
   */
  protected function getWizardField_types() {
    $field_types = array();
